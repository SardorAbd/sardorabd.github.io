...
var baguetteBox = (function() {
  ...
  function e() {
    return (b = v("baguetteBox-overlay"))
      ? ((k = v("baguetteBox-slider")),
        (w = v("previous-button")),
        (C = v("next-button")),
        void (T = v("close-button")))
      : ((b = y("div")),
  ...
  function o(t) {
    ...
    (k.style.transition = k.style.webkitTransition =
      "fadeIn" === I.animation
        ? "opacity .4s ease"
        : "slideIn" === I.animation
        ? ""
        : "none"),
      "auto" === I.buttons &&
        ("ontouchstart" in window || 1 === D[M].length) &&
        (I.buttons = !1),
  ...
  function s(t, e) {
    ...
    if ("undefined" != typeof n) {
      ...
      (imageElement = D[M][t]),
        (imageCaption =
          "function" == typeof I.captions
            ? I.captions.call(D[M], imageElement)
      ...
      n.appendChild(i),
        ...
        I.captions &&
          imageCaption &&
          ((a.innerHTML = imageCaption), i.appendChild(a)),
        I.async && e && e();
    }
  }
  function l(t) {
    ...
    if (t.dataset) {
      ...
      for (
        var o = window.innerWidth * window.devicePixelRatio, a = 0;
  ...
  return (
    ...
    { run: t, showNext: u, showPrevious: c }
  );
})();
...
$(function() {
  ...
  $.getJSON("js/gallery.json", {
    ...
    loadGalleryImages(($galleryItems = images));
  });

  function loadGalleryImages(images) {
    $.each(images, function(num) {
      $gallery.append(
        '<div class="col-lg-4 gallery-content-image">' +
          '<a href="./img/The-Dead’s-Poet-Society-1.jpg" class="photo-box _current_image_link_">' +
          '<img class="_current_image_src_" src="./img/The-Dead’s-Poet-Society-1.jpg" alt="Gallery Image Not Found" />' +
          "</a>" +
          "</div>"
      );

      $("._current_image_link_").attr("href", images[num].url);
      $("._current_image_link_").removeClass("_current_image_link_");

      $("._current_image_src_").attr("src", images[num].url);
      $("._current_image_src_").removeClass("_current_image_src_");
    });
